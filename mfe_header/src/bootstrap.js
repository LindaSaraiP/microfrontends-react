...
//   try {
//     // 1. Cargar los estilos compartidos
//     await Promise.all([
...
//     if (isFederated) {
//       // 2. MODO FEDERADO – el host configura 
//       console.log('[MFE] Modo federado: sin configuración de PrimeReact');
//       root.render(<App />);
//     } else {
//       // 3. MODO STANDALONE – sólo usamos PrimeReactProvider sin locale
//       const { PrimeReactProvider } = await import('primereact/api');
//       console.log('[MFE] Modo standalone: usando PrimeReactProvider (sin locale)');
//       root.render(
